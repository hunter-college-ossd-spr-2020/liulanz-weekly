...
<img src="https://raw.githubusercontent.com/hunter-college-ossd-spr-2020/liulanz-weekly/gh-pages/images/folding-screenshot.png">
...
#### **:cactus: April 16, 2020**

**Group Meeting**

We discussed on how we should work on the MongoDB + Next.js example together. For example, we can all modify/update the example by opening a pull request to hunter-college-ossd-spr-2020/next.js, and when we are finished with the example, we can rebase and open a pull request to next.js. I started off by [creating the with-mongodb directory](https://github.com/hunter-college-ossd-spr-2020/next.js/pull/1). 
